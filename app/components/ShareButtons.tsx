...
export function ShareButtons({ title, description }: ShareButtonsProps) {
  ...
  const currentUrl = `https://casualgames.studio${location.pathname}`;
  ...
  return (
    <div className="flex gap-1.5">
      ...
      <button
        ...
        className="rounded-full bg-sky-500 p-1.5 text-white hover:bg-sky-600 transition-colors"
      ...
      <button
        onClick={() => window.open(shareLinks.instagram, '_blank', 'width=600,height=400')}
        className="rounded-full bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 p-1.5 text-white hover:from-purple-700 hover:via-pink-600 hover:to-orange-500 transition-colors"
      ...
      <button
        ...
        className="rounded-full bg-green-500 p-1.5 text-white hover:bg-green-600 transition-colors"
